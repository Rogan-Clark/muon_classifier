'''Script to import sim_telarray GCT-S simulations,, clean them with 
a tailcut process, optionally plot them,  and export them to hdf5 files. 
Designed to mix muon, partial muon, and proton events together for machine learning.
...
Modified by R. Clark (rogan.clark@stcatz.ox.ac.uk) 20/01/2020'''
